    ...
    configureGrunt = function (grunt) {
        ...
        var cfg = {
            ...
            watch: {
                ...
                sass: {
                    files: [
                        'content/themes/casper/assets/sass/*.scss',
                        'content/themes/casper/assets/sass/**/*.scss'
                    ],
                    tasks: ['sass'],
                    options: {
            ...
            sass: {  
                dist: {
                    files: {
                        'content/themes/casper/assets/css/style.css': 'content/themes/casper/assets/sass/style.scss'
                    }
                }
            },
        ...
        grunt.registerTask('default', 'Build SASS, JS & templates for development',
